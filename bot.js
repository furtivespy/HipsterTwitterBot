...
var NameWords = ["amber", "anchor", "ankh", "awl", "apple", "argyle", "armor", "arrow", "badger", "ballast", "branch",
				 "balsam", "bantam", "barber", "barley", "barrow", "basil", "basin", "basket", "battle", "bowl", "beast",
				 ...
				 "burlap", "butler", "butter", "button", "cabbage", "cable", "cactus", "camphor", "candle", "coyote",
				 ...
				 "dinner", "doctor", "dollar", "donkey", "dovetail", "dutchess", "eagle", "earthquake", "fossil", "hinge",
				 "empress", "engine", "family", "father", "faucet", "favor", "feather", "fiddle", "fiddler", "funk", "gutter",
				 "flower", "fortune", "freckle", "galley", "gannet", "garnet", "gingham", "goblin", "goldfish", "foam",
				 "hammer", "hazel", "heather", "hobby", "holly", "honey", "jackal", "jacket", "jewel", "justice", "king",
				 "kerning", "lady", "lawyer", "leather", "leopard", "letter", "lettuce", "linen", "lion", "lace", "lustre",
				 "lobster", "locket", "lumber", "magic", "marble", "market", "marlin", "marrow", "mayor", "meta", "octopus",
				 "pork", "mitten", "money", "morning", "mortar", "mother", "mountain", "mushroom", "music", "night",
				 "nation", "needle", "nickel", "notebook", "novel", "number", "nutmeg", "oatmeal", "ocean", "peach",
...
var Descriptors = ["artisanal", "artisan", "asymmetrical", "bearded", "trendy", "bespoke", "fixed-gear", "flannel", "ironic", "kitschy", "organic", 
				   ...
				   "sophisticated", "fermented", "liberated", "charismatic", "brick", "fresh", "contemporary", "androgynous", "conceptual", 
				   "ambient", "delicate", "guerilla", "unrecognizable", "decorative", "musical", "wild", "miniature", "extinct", "series of", 
				   "relatable", "social", "charitable", "ethnic", "wind-powered", "metallic", "fluoridated", "semicontinuous", "semiclassical",
				   "precivilization", "ante mortem", "poisonous", "vectible"    ];
...
var Products = ["cardigans", "glasses", "tattoos", "cocktails", "fedoras", "bicycles", "kale", "leggings", "mustaches", "whiskey", "beer", 
				...
				"avocados", "chocolate", "nutella", "vodka", "honey", "headbands", "jorts", "overalls", "soups", "stews", "sleep masks", "airships",
				"handlebars", "glacier water", "steaks", "grandfather clocks", "news", "stamps", "polaroid cameras", "chili", "housedresses",
				"cookies", "grits"	   ];
